...
public class WordtrainerBackendTest {
   ...
   public void testWordpairHandeling(){
        ...
        wtb.addWordpair(wp2);
        wtb.addWordpair(wp3);
        assertEquals( new Wordpair[]{wp1, wp2,wp3},wtb.getWordpairs(),"Wordpair List is not as excpected");
        ...
        assertEquals(wp1,wtb.getWordpair(0),"Order of wordpairs did not correctly shift, on deletion of predecessor");
    }
    @Test
